...
<body style="background-color: #B6E5D8;">
<?php
...
<h1 style="text-align: center;color: red;">Change Password ???</h1>
<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="POST" name ="pass" onsubmit="return isValid();">
 <fieldset style="background-color:#8FDDE7;text-align: center;">
 ...
 <br><br><div style="text-align : center"><input type="submit" value="Submit"></div>
 </form>
 <br>
